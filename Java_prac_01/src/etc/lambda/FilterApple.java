...
public class FilterApple {
    ...
    public static List<Apple> filterGreen(List<Apple> basket){
        // green만 모아놓을 리스트
    ...
    public static List<Apple>  filterApple(List<Apple> basket,
    ...
    /**
     * problem - 이제는 appleList만 오는게 아니라서,
     *          다양한 데이터타입도 필터링을 하자!
     *
     * solution - try4 : 제네릭 필터 메소드를 선언
     *
     */

    public static <T> List<T>  filterAny(List<T> basket,
